...
| 13 | The add book button disappears and changes to loading when the user clicks on it | Add book Page |[Link](https://drive.google.com/file/d/1kkLzJS6wsPhfKQkjTN4bjmKP_OcwU6cS/view?usp=sharing)| For user friendliness, instead of the add button disappearing, it could become disabled |
